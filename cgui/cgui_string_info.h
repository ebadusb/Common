...
public:
	...
	bool get( const string & stringKey, const CGUIFontId * fontId, CGUITextItem & result, int fontIndex = 0 );
...
private:
	...
	CGUIStringInfo(const CGUIStringInfo &obj);
	CGUIStringInfo& operator=(const CGUIStringInfo &obj);
};

...
DataLog_InitTable	initTable[] =
{
	{ &log_level_message_system_timer_info, &log_handle_message_system_timer_info, "message_system_timer_info" },
	{ &log_level_message_system_timer_error, &log_handle_message_system_timer_error, "message_system_timer_error" },
	{ &log_level_router_info, &log_handle_router_info, "router_info" },
	{ &log_level_router_error, &log_handle_router_error, "router_error" },
	{ &log_level_gateway_info, &log_handle_gateway_info, "gateway_info" },
	{ &log_level_gateway_error, &log_handle_gateway_error, "gateway_error" },
	{ &log_level_message_spoof_info, &log_handle_message_spoof_info, "message_spoof_info" },
	{ &log_level_message_spoof_error, &log_handle_message_spoof_error, "message_spoof_error" },
	{ &log_level_message_system_info, &log_handle_message_system_info, "message_system_info" },
	{ &log_level_message_system_error, &log_handle_message_system_error, "message_system_error" },

	{ &log_level_datalog_info, &log_handle_datalog_info, "datalog_info" },
	{ &log_level_datalog_error, &log_handle_datalog_error, "datalog_error" },

	{ &log_level_vxworks_info, &log_handle_vxworks_info, "vxworks_info" },
	{ &log_level_vxworks_error, &log_handle_vxworks_error, "vxworks_error" },

	{ &log_level_cds_info, &log_handle_cds_info, "cds_info" },
	{ &log_level_cds_error, &log_handle_cds_error, "cds_error" },
	{ &log_level_cds_debug, &log_handle_cds_debug, "cds_debug" },
	{ &log_level_cds_spoof_info, &log_handle_cds_spoof_info, "cds_spoof_info" },
	{ &log_level_cds_spoof_error, &log_handle_cds_spoof_error, "cds_spoof_error" },
	{ &log_level_socket_info, &log_handle_socket_info, "socket_info" },
	{ &log_level_socket_error, &log_handle_socket_error, "socket_error" },
};

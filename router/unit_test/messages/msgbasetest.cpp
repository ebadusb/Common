...
void callback() {  cout << "Recieved message" << endl; };
void testMsgSystem();
...
STATUS msgPcktTest (void)
{
   ...
   cout << "--------------- Dispatch ---------------------------------" << endl;
   MessageSystem::MsgSystem()->dispatcher().dump();
...
void testMsgSystem()
{
   ...
   cout << "Data :" << mb1.get()._Array << endl;

   cout << "--------------- Dispatch ---------------------------------" << endl;
   MessageSystem::MsgSystem()->dispatcher().dump();
   cout << "--------------- Create MB2 --------------------------------------" << endl;
   Message<temp> mb2( CallbackBase( & ::callback ), MessageBase::SNDRCV_RECEIVE_ONLY );
   cout << "--------------- MB2 --------------------------------------" << endl;
   mb2.dump();
   cout << "--------------- Dispatch ---------------------------------" << endl;
   MessageSystem::MsgSystem()->dispatcher().dump();

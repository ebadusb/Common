// $Header: K:/BCT_Development/Taos/tools/config_parse/unit_test/test2/rcs/test2_main.cpp 1.1 2005/01/25 20:54:38Z jl11312 Exp jl11312 $
//
...
int test2_main(void)
{
	...
	if ( Test2::Test2_A_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadOK )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_D_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed ||
		  Test2::Test2_E_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed ||
		  Test2::Test2_F_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_G_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed ||
		  Test2::Test2_H_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed ||
		  Test2::Test2_I_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_J_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_K_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_L_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	fprintf(fp, "0x1f43d96f\n");
	fclose(fp);

	fprintf(stderr, "Test 2.16 ...\n");
	if ( Test2::Test2_B_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadOK )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_B_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadFailed )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	fprintf(fp, "0x2fc6b8e9\n");
	fclose(fp);

	fprintf(stderr, "Test 2.18 ...\n");
	if ( Test2::Test2_B_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadBackupOK )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_C_Access.writeFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::WriteOK )
	{
		fprintf(stderr, "test failed\n");
		return -1;
	}
	...
	if ( Test2::Test2_C_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadOK ||
	...
	if ( Test2::Test2_C_Access.readFile(&log_level_startup_info, &log_level_startup_error) != ConfigFile::ReadBackupOK ||
		  strcmp(Test2::Test2_C().Version.FormatVersion, "2c") != 0 ||
		  strcmp(Test2::Test2_C().Version.DataVersion, "1") != 0 ||
		  Test2::Test2_C().Section1.Param201[0] != Test2::enum4_id1 ||
		  Test2::Test2_C().Section2.Param1[0] != 1 ||
